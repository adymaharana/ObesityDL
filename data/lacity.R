...
#Read the data
datx <- read.table("~/Dropbox/obesity/Los Angeles/X_lacity_fc7_vggf_z18.txt", stringsAsFactors = FALSE) #4096
...
write.table(fin.coef, "~/Dropbox/obesity/Los Angeles/significant_coeffs_features.txt", row.names=FALSE)

##########################################################################################
##########################################################################################
#Analysis with point of interest
#Read the data
datx <- read.table("~/Dropbox/obesity/Los Angeles/X_lacity_poi.txt", stringsAsFactors = FALSE) #4096
daty <- read.table("~/Dropbox/obesity/Los Angeles/y_lacity_fc7_vggf_z18.txt", stringsAsFactors = FALSE)
...
fin.coef <- temp.dat[order(temp.dat$coefficients, decreasing=TRUE),]
fin.coef <- subset(fin.coef, coefficients != 0)
write.table(fin.coef, "~/Dropbox/obesity/Los Angeles/significant_coeffs_poi.txt", row.names=FALSE)

##########################################################################################
##########################################################################################
#Analysis with combined point of interest and features data
#Read the data
datx1 <- read.table("~/Dropbox/obesity/Los Angeles/X_lacity_poi.txt", stringsAsFactors = FALSE)
datx2 <- read.table("~/Dropbox/obesity/Los Angeles/X_lacity_fc7_vggf_z18.txt", stringsAsFactors = FALSE) #4096
datx <- cbind(datx1, datx2); dim(datx)
daty <- read.table("~/Dropbox/obesity/Los Angeles/y_lacity_fc7_vggf_z18.txt", stringsAsFactors = FALSE)#4197
...
out <- data.frame(cbind(yhat, daty))
colnames(out) <- c("predict_all", "true_all")
write.table(out, "~/Dropbox/obesity/Los Angeles/predicted_combined.txt", row.names=FALSE, col.names=TRUE, quote=FALSE)
...
fin.coef <- temp.dat[order(temp.dat$coefficients, decreasing=TRUE),]
fin.coef <- subset(fin.coef, coefficients != 0)
write.table(fin.coef, "~/Dropbox/obesity/Los Angeles/significant_coeffs_combined.txt", row.names=FALSE)
...
#Read the data
dat <- read.table("~/Dropbox/obesity/Los Angeles/X_lacity_fc7_vggf_z18.txt", stringsAsFactors = FALSE) #4096
daty <- read.table("~/Dropbox/obesity/Los Angeles/y_lacity_fc7_vggf_z18.txt", stringsAsFactors = FALSE)
...
colnames(out) <- c("predict_all", "true_all")
write.table(out, "~/Dropbox/obesity/Los Angeles/predicted_outsample.txt", row.names=FALSE, col.names=TRUE, quote=FALSE)
...
out <- data.frame(cbind(yhat, daty.test))
colnames(out) <- c("predict_all", "true_all")
write.table(out, "~/Dropbox/obesity/Los Angeles/predicted_poi_outsample.txt", row.names=FALSE, col.names=TRUE, quote=FALSE)
